...
window.CBML_NAV = [
  {
    ...
    items: [
      { href: "p1-what-is-ml.html", title: "What is Machine Learning?",
        desc: "The plain-language foundation: learning paradigms, features vs labels, training vs inference, and the end-to-end ML lifecycle." },
      { href: "p1-classical-ml.html", title: "Classical Machine Learning",
        desc: "The baselines that still win — linear/logistic regression, decision trees, random forests, gradient-boosted trees, k-NN & k-means." },
      { href: "p1-neural-networks.html", title: "Neural Networks & Deep Learning",
        desc: "From a single neuron to a deep network: the forward pass, backpropagation, gradient descent, and choosing DL over classical ML." },
      { href: "p1-tokenization-embeddings.html", title: "Tokenization, Embeddings & NLP",
        desc: "How text becomes numbers: subword tokenization (BPE), embedding vectors, and positional encoding (sinusoidal & RoPE)." },
      { href: "p1-transformers.html", title: "Transformers & Self-Attention",
        desc: "Why transformers replaced RNNs, self-attention derived from scratch, multi-head attention, and the transformer block." },
      { href: "p1-genai-llm-slm.html", title: "GenAI, LLMs & SLMs",
        desc: "Autoregressive generation, decoding knobs, scaling laws & model size, and the Large- vs Small-Language-Model cost decision." },
    ],
  },
  {
    part: "Part 2",
